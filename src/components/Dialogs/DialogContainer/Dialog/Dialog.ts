  ...
  render() {
    ...
    return `
      <main class="messages">
        ...
        <div class="message__container {{#ifCond this.sender.id '===' ../myId}}message_out{{/ifCond}}{{#ifCond this.sender.id '!==' ../myId}}message_in{{/ifCond}} {{#if this.first}}message_first{{/if}}">
