    ...
    return `
        <ul class="{{#unless openAttach}}elem-hidden{{/unless}} draw-list send-message__draw-list">
          <li class="draw-list__item">
            <!-- хотелось бы, чтобы при нажатии на иконку тоже открывалось меню загрузки файла, можно ли div в label запихнуть?
            поискал информацию в инете, похоже на холиварную тему -->
